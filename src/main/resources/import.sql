...
CREATE TABLE token_table              (id serial PRIMARY KEY, dele INT UNSIGNED, comment varchar(80), global_save_id INT UNSIGNED, record_local_save_count INT UNSIGNED, token_hash varchar(80));
CREATE TABLE ninja_table              (id serial PRIMARY KEY, dele INT UNSIGNED, comment varchar(80), global_save_id INT UNSIGNED, record_local_save_count INT UNSIGNED, name varchar(80), phone INT UNSIGNED, email varchar(80), portfolio_url varchar(80) );
CREATE TABLE riddle_table             (id serial PRIMARY KEY, dele INT UNSIGNED, comment varchar(80), global_save_id INT UNSIGNED, record_local_save_count INT UNSIGNED, id serial PRIMARY KEY, text varchar(800) );
CREATE TABLE rhyme_table              (id serial PRIMARY KEY, dele INT UNSIGNED, comment varchar(80), global_save_id INT UNSIGNED, record_local_save_count INT UNSIGNED, id serial PRIMARY KEY, text varchar(80) );
