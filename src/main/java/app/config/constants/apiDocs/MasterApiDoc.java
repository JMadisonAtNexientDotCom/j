package app.config.constants.apiDocs;
...
import app.config.constants.signatures.sig.CardCount_NumQuips_TruMin_TruMax_EndPoint;
import app.config.constants.signatures.sig.HttpPost_EndPoint;
import app.config.constants.signatures.sig.Id_EndPoint;
import app.config.constants.signatures.sig.Name_Phone_Email_PortfolioUrl_EndPoint;
import app.config.constants.signatures.sig.NinjaIdList_TrialKind_DurationInMinutes_EndPoint;
import app.config.constants.signatures.sig.PageIndex_NumResultsPerPage;
import app.config.constants.signatures.sig.PageIndex_NumResultsPerPage_EndPoint;
import app.config.constants.signatures.sig.Quip1_EndPoint;
import app.config.constants.signatures.sig.Quip2_EndPoint;
import app.config.constants.signatures.sig.Quip3_EndPoint;
import app.config.constants.signatures.sig.Quip4_EndPoint;
import app.config.constants.signatures.sig.RiddleId_EndPoint;
import app.config.constants.signatures.sig.RiddleId_NumberOfChoices_NumberOfTruths_EndPoint;
import app.config.constants.signatures.sig.RiddleId_RhymeId_EndPoint;
import app.config.constants.signatures.sig.TokenHash_EndPoint;
import app.config.constants.signatures.sig.TokenId_AdminId_EndPoint;
import app.config.constants.signatures.sig.TokenId_EndPoint;
import app.config.constants.signatures.sig.TokenId_NinjaId_EndPoint;
import app.config.constants.signatures.sig.UserName_PassWord_EndPoint;
import app.config.constants.signatures.sig.Void_EndPoint;
import app.servlets.rest.restCore.AdminCTRL;
import app.servlets.rest.restCore.InkCTRL;
import app.servlets.rest.restCore.NinjaCTRL;
import app.servlets.rest.restCore.OwnerCTRL;
import app.servlets.rest.restCore.TokenCTRL;
import app.servlets.rest.restCore.TrialCTRL;
import app.servlets.rest.restCore.RiddleRhymeCTRL;
