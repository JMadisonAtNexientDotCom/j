...
import app.servlets.rest.restCore.components.trial.Book; //standardize into object.
import app.servlets.rest.restCore.components.trial.Chop; //Halve object. good/bad
import app.servlets.rest.restCore.components.trial.Fill; //Fill the orders.
import app.servlets.rest.restCore.components.trial.Join; //Join the orders.
import app.servlets.rest.restCore.components.trial.Shop;
