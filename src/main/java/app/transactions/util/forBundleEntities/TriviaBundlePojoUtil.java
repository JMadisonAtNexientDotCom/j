package app.transactions.util.forBundleEntities;
...
import app.transactions.util.tables.deck.DeckPojoUtil;
import app.transactions.util.forCompositeEntities.QuarPojoUtil;
