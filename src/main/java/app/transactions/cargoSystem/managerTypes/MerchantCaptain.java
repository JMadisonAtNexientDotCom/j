package app.transactions.cargoSystem.managerTypes;

import java.util.List;
import app.MyError;
import app.transactions.cargoSystem.dataTypes.AgendaClipBoard;
import app.transactions.cargoSystem.dataTypes.CargoHold;
