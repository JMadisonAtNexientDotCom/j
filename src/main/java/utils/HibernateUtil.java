...
import app.dbDataAbstractions.entities.tables.AdminTable;
import app.dbDataAbstractions.entities.tables.ChalkPurse;
import app.dbDataAbstractions.entities.tables.ChalkTable;
...
import app.dbDataAbstractions.entities.tables.QuarPurse;
import app.dbDataAbstractions.entities.tables.QuarTable;
import app.dbDataAbstractions.entities.tables.RhymeTable;
import app.dbDataAbstractions.entities.tables.RiddleRhymeTruthTable;
import app.dbDataAbstractions.entities.tables.RiddleRhymeWrongTable;
import app.dbDataAbstractions.entities.tables.RiddleTable;
import app.dbDataAbstractions.entities.tables.SessionTable;
import app.dbDataAbstractions.entities.tables.SlateTable;
import app.dbDataAbstractions.entities.tables.TestTable01;
...
import app.dbDataAbstractions.entities.tables.riddleTrialStore.questionStore.InkPurse;
import app.dbDataAbstractions.entities.tables.riddleTrialStore.questionStore.InkTable;
import app.debug.debugUtils.entity.EntityColumnDebugUtil;
import app.debug.debugUtils.entity.EntityTableNameDebugUtil;
